...
.v-field--disabled .v-label.v-field-label, .v-field--focused .v-label.v-field-label, .v-field--error .v-label.v-field-label {
  opacity: 1;
}
...
.v-tabs--centered .v-slide-group__content > *:last-child {
  -webkit-margin-end: auto;
          margin-inline-end: auto;
}
.v-tabs--fixed-tabs .v-slide-group__content > *:first-child,
.v-tabs--centered .v-slide-group__content > *:first-child {
  -webkit-margin-start: auto;
          margin-inline-start: auto;
}
...
.v-table--fixed-footer > .v-table__wrapper > table > tfoot > tr > th {
  ...
  line-height: 1.75;
  outline: none;
  -webkit-mask-image: linear-gradient(to bottom, transparent, transparent calc(var(--v-field-padding-top, 0) / 1.25), black var(--v-field-padding-top, 0));
...
.v-timeline--vertical.v-timeline--inset-line .v-timeline-item:last-child .v-timeline-divider__line.v-locale--is-rtl, .v-locale--is-rtl .v-timeline--vertical.v-timeline--inset-line .v-timeline-item:last-child .v-timeline-divider__line {
  ...
  max-width: 100%;
  overflow: hidden;
  -webkit-padding-end: calc(16px + var(--v-scrollbar-offset));
...
.v-slider-thumb--focused .v-slider-thumb__surface::before, .v-slider-thumb:hover .v-slider-thumb__surface::before {
  transform: scale(2);
}
